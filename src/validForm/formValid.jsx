...
import classess from "../validForm/formValid.module.css"
...
const FormForValid=()=>{
    ...
    return(
        ...
        <form className="form" >
            ...
            <p className={classess.errMsg} name="errorName" >{errVal.errorName}</p>
            ...
            <p className={classess.errMsg} name="errorPhone" >{errVal.errorPhone}</p>
            ...
            <p className={classess.errMsg} name="errorEmail" >{errVal.errorEmail}</p>
            ...
            <p className={classess.errMsg} name="errorMsg" >{errVal.errorMsg}</p>
